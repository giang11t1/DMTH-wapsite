$(document).ready(function() {
	...
	if($('#menu_fixed').length > 0){
	  ...
	  if($('#scroll-menu').length > 0){
	  	var eTop1 = $('#position-scroll').offset().top; //get the offset top of the element
	      $(window).scroll(function() { //when window is scrolled
...
(function (e) {
	  ...
	  $("#countdown1,#countdown2,#countdown3,#countdown4,#countdown5,#countdown6").countdown({
...
$(document).ready(function() {
  ...
  // main menu
  $("#main-menu .modal-dialog ul li").click(function(){
  	$("#main-menu .modal-dialog ul li").removeClass("active");
  	$(this).addClass("active");
  });

     $(".btn-cat").click(function(){
     	$("#show").addClass("modal-backdrop1");
     	$('#main-menu').addClass("in");
     	$('#main-menu').animate({"left":"-1px"}, "slow");
     	$(".modal-backdrop").show();
     });
     $("#btn-close").click(function(){
     	$("#show").removeClass("modal-backdrop1");
     	$('.modal#main-menu').animate({"left":"-290px"}, "fast");
...
$(document).ready(function(){
	...
	// choose value option
	$( "#choose-payment" ).change(function() {
		$( "#opt1:selected" ).each(function() {
	      	$(".payment-zero").slideDown();
			$(".payment-low").slideUp();
			$(".btn1").show();
			$(".btn2").hide();
	    });
		...
		$( "#opt2:selected" ).each(function() {
	      	$(".payment-zero").slideUp();
			$(".payment-low").slideDown();
			$(".btn2").show();
			$(".btn1").hide();
	    });
  	}); 	
